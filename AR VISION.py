...
ball_image = pygame.transform.scale(ball_image, (60, 60))  # size of picture ball
...
# --------------------------------
# GAME LOOP (updated to use image)
# --------------------------------
def run_game():
    ...
    while running:
        ...
        # ---------------------
        # DRAW BALL IMAGE HERE
        # ---------------------
        ball_rect = ball_image.get_rect(center=(int(ball_x) + shake_x, int(ball_y) + shake_y))
